...
import { FilterQuery, Model, RootFilterQuery, Types, UpdateQuery } from "mongoose";
...
export class TodoItemRepository implements IRepository<TodoItem> {
    ...
    async update(id: Types.ObjectId, todoItem: UpdateQuery<TodoItem>): Promise<TodoItemDocument> {
